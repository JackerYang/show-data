...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      this.$store.commit("SET_MAP_CHAR", echarts.init(document.getElementById("map-char"), {}));
      ...
      let localData = [
        ...
        ["拉萨", [
          ...
          [{ name: "拉萨" }, { name: "太原", value: 44 }],
          [{ name: "拉萨" }, { name: "北京", value: 40 }],
          [{ name: "拉萨" }, { name: "重庆", value: 37 }],
          [{ name: "拉萨" }, { name: "西安", value: 34 }],
          [{ name: "拉萨" }, { name: "青岛", value: 23 }],
          [{ name: "拉萨" }, { name: "葫芦岛", value: 22 }],
          [{ name: "拉萨" }, { name: "福州", value: 20 }],
          [{ name: "拉萨" }, { name: "连云港", value: 12 }],
          [{ name: "拉萨" }, { name: "海口", value: 10 }]
        ]]
      ];
      ...
      let color = ["#a6c84c", "#ffa022", "#46bee9", "#805BCE"];
            ...
            lineStyle: {
              normal: {
                color: params => {
                  ...
                  let num = item[1][dataIndex][1].value;
                  if (num > 60) {
                    return color[0];
                  } else if (num > 30) {
                    return color[1];
      ...
      let option = {
        ...
        legend: {
          ...
          top: "bottom",
          left: "right",
          data: localData.map(item => item[0] + " Top10"),
          textStyle: {
            color: "#fff"
          },
          selectedMode: "single"
